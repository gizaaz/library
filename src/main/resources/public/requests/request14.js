...
app.controller("AppCtrl", function ($http, $scope){
    ...
    $http.get('http://localhost:8080/request/request14?firstDate='+date1+'&secondDate='+
    ...
    this.update_request = function add() {
        ...
        $http.get('http://localhost:8080/request/request14?firstDate='+date1+'&secondDate='+date2).then(function (response){
            $scope.request14=response.data;
            console.log(response);
        });
    };
